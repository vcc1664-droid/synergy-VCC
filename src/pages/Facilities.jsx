    ...
    <>
      ...
      <section className="sec" style={{ padding: '60px 0 40px' }}>
        <div className="wrap">
          ...
          >
            <div className="fac-zones-text">
              <h2 className="sec-title" data-anim="up" style={{ margin: '0 0 16px', lineHeight: 1.15 }}>
                <span className="hline">Four temperature zones,</span>
                <span className="hline"><span className="accent">one cold floor.</span></span>
              </h2>
              <p className="sec-sub" style={{ maxWidth: 680, margin: 0, lineHeight: 1.65 }}>
