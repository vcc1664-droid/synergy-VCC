...
const STEPS = [
  {
    ...
    desc: 'Customer order received with cargo, temperature needs and SLAs.',
  ...
  },
  {
    ...
    desc: 'Each pallet or SKU tagged with UHF RFID for a unique identity and full traceability.',
  ...
  },
  {
    ...
    desc: 'Order, inventory and user data synced to our cloud-based Warehouse Management System.',
  ...
  },
  {
    ...
    desc: 'Dock, slot and receiving time auto-assigned based on availability and cargo profile.',
  ...
  },
  {
    ...
    desc: 'RFID scan, IoT sensor check and quality validation performed on arrival.',
  ...
  },
  {
    ...
    desc: 'Pallets moved to designated zones using AI-optimised path planning.',
  ...
  },
  {
    ...
    desc: '24/7 monitoring of temperature, humidity, power and equipment health via IoT.',
    tags: ['24/7 IoT', 'LIVE'],
  ...
  },
  {
    ...
    desc: 'Digital verification, AI-driven route planning and dispatch execution, with a full audit trail.',
...
export default function ProcessSection() {
  ...
  return (
    <section className="sec" id="how" style={{ padding: 'clamp(60px,7vw,90px) 0 clamp(40px,5vw,70px)', background: '#ffffff' }}>
      <div className="wrap">
        <h2 className="sec-title" data-anim="up" style={{ textAlign: 'center', marginTop: 0, color: '#070f30' }}>
          <span className="hline">Smart Cold Storage.</span>
          <span className="hline">
            <span style={{ color: '#888FA2', fontWeight: 800, paddingRight: '4px' }}>
              Seamless
            </span>{' '}
            from Start to Store.
          </span>
        </h2>
        <p className="sec-sub" data-anim="up" style={{ maxWidth: 720, margin: '14px auto 36px', textAlign: 'center', color: '#4b5563', lineHeight: 1.6 }}>
